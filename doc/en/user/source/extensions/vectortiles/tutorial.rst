...
GeoServer now supports **metatiling for Vector Tiles**, extending a well-known optimization technique from WMS rendering to tiles generation.
This feature can significantly improves performance and database efficiency.
...
This approach is particularly beneficial for complex vector datasets, especially when seeding tiles.
...
* geometries are expanded and clipped
