...
public class DownloadMapProcessTest extends BaseDownloadImageProcessTest {
    ...
    protected void testExecutMultiLayerKmz(String mime) throws Exception {
        ...
        try (ZipInputStream zis =
            ...
            assertXpathEvaluatesTo(
                    "image.png", "//kml:Folder/kml:GroundOverlay/kml:Icon/kml:href", dom);
            // axis order check
            assertXpathEvaluatesTo(
                    "-0.003", "//kml:Folder/kml:GroundOverlay/kml:LatLonBox/kml:west", dom);
            assertXpathEvaluatesTo(
                    "0.003", "//kml:Folder/kml:GroundOverlay/kml:LatLonBox/kml:east", dom);
