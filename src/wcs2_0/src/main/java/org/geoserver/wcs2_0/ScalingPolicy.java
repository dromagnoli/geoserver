...
enum ScalingPolicy {
    ...
    ScaleByFactor {
        ...
        public GridCoverage2D scale(GridCoverage2D sourceGC, ScalingType scaling,
            ...
            scaleFactor = arrangeScaleFactor(hints, new double[]{scaleFactor, scaleFactor})[0];
    ...
    ScaleAxesByFactor {
        ...
        public GridCoverage2D scale(GridCoverage2D sourceGC, ScalingType scaling,
            ...
            scaleFactors = arrangeScaleFactor(hints, scaleFactors);
    ...
    private static double[] arrangeScaleFactor(Hints hints, double[] scaleFactor) {
        if (hints != null && hints.containsKey(GetCoverage.PRE_APPLIED_SCALE)) {
            ...
            if (preAppliedScale != null) {
                scaleFactor[0] = scaleFactor[0] * preAppliedScale[0];
                scaleFactor[1] = scaleFactor[1] * preAppliedScale[1];
            }
        }
        return scaleFactor;
    }
