...
public final class MemoryGuardedVectorTileBuilder implements VectorTileBuilder {
    ...
    static long estimateBytes(
        ...
        if (props != null && !props.isEmpty()) {
            ...
            // Keep it simple: cheap fixed cost per tag + cost for string values.
            for (Map.Entry<String, Object> e : props.entrySet()) {
                ...
                if (v instanceof CharSequence cs) {
                    ...
                    size += 16; // unknown object bucket; DO NOT toString()
                }
            }
        }
    ...
    private static int fastRingCount(Geometry g) {
        ...
        if (g instanceof Polygon p) {
            ...
            // geometry collections: scan only top-level children, still cheap
