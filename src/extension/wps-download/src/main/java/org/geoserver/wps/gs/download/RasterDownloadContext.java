...
/**
 * Represents the context for downloading raster data, managing parameters and processing details
 * for raster coverage extraction and transformation.
 *
 */
class RasterDownloadContext {
    ...
    /**
         ...
         *
         * If no target size is specified, automatically computes grid geometry using the CRS request handler.
         * If partial target size is provided, calculates the missing dimension using scaling.
         * Creates a new GridGeometry2D with the specified or computed target size and target envelope.
         *
         ...
         */
    public void computeGridGeometry(
            GridCoverage2DReader reader, CRSRequestHandler crsRequestHandler)
