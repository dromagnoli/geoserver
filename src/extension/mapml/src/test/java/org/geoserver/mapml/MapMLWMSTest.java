...
public class MapMLWMSTest extends MapMLTestSupport {
    ...
    protected void onSetUp(SystemTestData testData) throws Exception {
        ...
        CoordinateReferenceSystem webMerc = MapMLOutput.PREVIEW_TCRS_MAP.get("OSMTILE").getCRS();
        Bounds webMercBounds = MapMLOutput.PREVIEW_TCRS_MAP.get("OSMTILE").getBounds();
    ...
    public void testMapMLSingleLayer() throws Exception {
        ...
        assertSame(
                MapMLOutput.PREVIEW_TCRS_MAP.get("OSMTILE").getCRS(),
