...
public class GeoServerTileLayer extends TileLayer implements ProxyLayer, TileJSONProvider {
    ...
    private boolean supportsMetaTiling(MimeType mime) {
        ...
        List<MetaTilingOutputFormat> metaTilingOutputFormatList =
                GeoServerExtensions.extensions(MetaTilingOutputFormat.class);
    ...
    public void seedTile(ConveyorTile tile, boolean tryCache) throws GeoWebCacheException, IOException {
        ...
        if (!supportsMetaTiling(tile.getMimeType())) {
            metaX = metaY = 1;
        }
