...
import org.geoserver.web.data.store.raster.CogRasterEditPanel;
...
public class CogInput extends Panel {
    ...
    public CogInput(
        ...
        textField =
                new AutoCompleteTextField<String>("paramValue", getCogFileModel(paramValue)) {
                    @Override
                    protected Iterator<String> getChoices(String input) {
                        try {
                            // do we need to filter files?
                            FileFilter fileFilter =
                                    org.geoserver.web.wicket.browser.CogInput.this.fileFilter
                                                    != null
                                            ? org.geoserver.web.wicket.browser.CogInput.this
                                                    .fileFilter.getObject()
                                            : null;
    ...
    protected IModel<String> getCogFileModel(IModel<String> paramValue) {
        return new CogRasterEditPanel.CogModel(paramValue);
    }
