...
public class CoverageViewEditorTest extends GeoServerWicketTestSupport {
    ...
    public void testSingleBandsIndexIsNotVisible() throws Exception {
        ...
        ListMultipleChoice availableBands =
                (ListMultipleChoice) tester.getComponentFromLastRenderedPage("form:coverages:bandChoiceContainer:coveragesChoice");
        ListMultipleChoice selectedBands =
                (ListMultipleChoice) tester.getComponentFromLastRenderedPage("form:coverages:bandChoiceContainer:outputBandsChoice");
    ...
    public void testJiffleModeCreatesCorrectBands() throws Exception {
        ...
        FormTester formTester = tester.newFormTester("form");
        formTester.select("coverages:editorMode", 1); // assuming 1 = JIFFLE
        tester.executeAjaxEvent("form:coverages:editorMode", "change");
        ...
        // Submit form
        formTester.submit("save");
        CoverageViewNewPage page = (CoverageViewNewPage) tester.getLastRenderedPage();
        ...
        List<CoverageView.CoverageBand> bands =
                (List<CoverageView.CoverageBand>) coverageViewEditor.outputBandsChoice.getChoices();
