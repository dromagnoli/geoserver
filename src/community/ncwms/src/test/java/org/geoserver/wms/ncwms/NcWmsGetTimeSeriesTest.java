...
public class NcWmsGetTimeSeriesTest extends WMSDimensionsTestSupport {
    ...
    public void testTimeList() throws Exception {
        setupRasterDimension(TIMESERIES, ResourceInfo.TIME, DimensionPresentation.LIST, null, null,
                null);
        ...
        assertCsvLine("value 2014-01-01", csvLines[3], "2014-01-01T00:00:00.000Z",
                16.88799985218793, DELTA);
        assertCsvLine("value 2015-01-01", csvLines[4], "2015-01-01T00:00:00.000Z",
                13.399999686516821, DELTA);
        assertCsvLine("value 2016-01-01", csvLines[5], "2016-01-01T00:00:00.000Z",
                13.331999683286995, DELTA);
        assertCsvLine("value 2017-01-01", csvLines[6], "2017-01-01T00:00:00.000Z",
                17.120999863254838, DELTA);
        ...
        assertCsvLine("value 2014-01-01", csvLines[3], "2014-01-01T00:00:00.000Z",
                16.88799985218793, DELTA);
        assertCsvLine("value 2017-01-01", csvLines[4], "2017-01-01T00:00:00.000Z",
                17.120999863254838, DELTA);
        ...
        csvLines = rawCsv.split("\\r?\\n");
        Assert.assertEquals("CSV Number of results", 7, csvLines.length);
        assertCsvLine("value 2010-01-01", csvLines[3], "2014-01-01T00:00:00.000Z",
                16.88799985218793, DELTA);
        assertCsvLine("value 2015-01-01", csvLines[4], "2015-01-01T00:00:00.000Z",
                13.399999686516821, DELTA);
        assertCsvLine("value 2016-01-01", csvLines[5], "2016-01-01T00:00:00.000Z",
    ...
    public void testTimeRangeWithPeriod() throws Exception {
        ...
        String rawCsv = getAsString(url);
        System.out.print(rawCsv);
        String[] csvLines = rawCsv.split("\\r?\\n");
        Assert.assertEquals("CSV Number of results", 5, csvLines.length);
        assertCsvLine("value 2014-01-01", csvLines[3], "2014-01-01T00:00:00.000Z",
                16.88799985218793, DELTA);
        assertCsvLine("value 2018-01-01", csvLines[4], "2018-01-01T00:00:00.000Z",
                16.88799985218793, DELTA);
        ...
        assertCsvLine("value 2017-01-01", csvLines[6], "2017-01-01T00:00:00.000Z",
                17.120999863254838, DELTA);
        assertCsvLine("value 2018-01-01", csvLines[7], "2018-01-01T00:00:00.000Z",
                16.88799985218793, DELTA);
        assertCsvLine("value 2019-01-01", csvLines[8], "2019-01-01T00:00:00.000Z",
                13.399999686516821, DELTA);
